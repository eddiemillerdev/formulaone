        ...
        <Card className="border-border/80 bg-card/80">
          <CardContent className="space-y-6 p-6 md:p-8 prose prose-sm dark:prose-invert max-w-none">
            <p className="text-muted-foreground">
              By using F1® Experiences and our website, you agree to these terms. We provide a platform for discovering and booking official F1® ticket and hospitality packages. All bookings are subject to the relevant event organiser’s terms and our booking conditions communicated at checkout.
            </p>
            <p className="text-muted-foreground">
