                      ...
                      {order.payment_deadline_at && (
                        <p className="mt-2 text-sm text-amber-700/90 dark:text-amber-200/90">
                          {deadlinePassed ? (
                            ...
                            <>Pay by <strong>{formatDate(order.payment_deadline_at)}</strong> (business days only). If your payment confirmation or receipt is not received by then, your order will be cancelled.</>
                          )}
                        </p>
                      )}
                    </div>
