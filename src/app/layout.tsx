...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: publicAssetUrl("/icons/favicon.ico"), sizes: "any" },
      { url: publicAssetUrl("/icons/icon-192.png"), sizes: "192x192", type: "image/png" },
      { url: publicAssetUrl("/icons/icon-512.png"), sizes: "512x512", type: "image/png" },
    ],
    apple: publicAssetUrl("/icons/apple-touch-icon.png"),
  },
    ...
    <html lang="en" suppressHydrationWarning>
      <head>
        <link
          ...
          rel="stylesheet"
        />
        {/* PWA: iOS splash screens (generated by scripts/generate-pwa-icons.js) */}
        <link
          rel="apple-touch-startup-image"
          href={publicAssetUrl("/icons/splash-1170x2532.png")}
          media="(device-width: 390px) and (device-height: 844px) and (-webkit-device-pixel-ratio: 3)"
        />
        <link
          rel="apple-touch-startup-image"
          href={publicAssetUrl("/icons/splash-1290x2796.png")}
          media="(device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 3)"
        />
        <link
          rel="apple-touch-startup-image"
          href={publicAssetUrl("/icons/splash-1242x2688.png")}
          media="(device-width: 414px) and (device-height: 896px) and (-webkit-device-pixel-ratio: 3)"
        />
        <link
          rel="apple-touch-startup-image"
          href={publicAssetUrl("/icons/splash-750x1334.png")}
          media="(device-width: 375px) and (device-height: 667px) and (-webkit-device-pixel-ratio: 2)"
        />
        <link
          rel="apple-touch-startup-image"
          href={publicAssetUrl("/icons/splash-2048x2732.png")}
